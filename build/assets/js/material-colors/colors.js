window.onload = () => {
    ...
    */
    ...
    let z = document.getElementById('colors');
    for(x in palette) {
    ...
    let a = document.getElementById('wrap-c');
    $('#colors').change(function() {
        //console.log(z.options[z.selectedIndex].value);
        let p = z.options[z.selectedIndex].value;

        if(document.getElementById('m-color')) {
            $('.color-div').remove();
        }
